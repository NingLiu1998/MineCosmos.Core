...
namespace MineCosmos.Core.Extensions
{
    public class AutofacModuleRegister : Autofac.Module
    {
        ...
        protected override void Load(ContainerBuilder builder)
        {
            ...
            var repositoryDllFile = Path.Combine(basePath, "MineCosmos.Core.Repository.dll");
            ...
            //var assemblysServicesNoInterfaces = Assembly.Load("MineCosmos.Core.Services");
