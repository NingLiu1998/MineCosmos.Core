...
namespace MineCosmos.Core.Common.Seed
{
    public class FrameSeed
    {
        ...
        {
            Create_Controller_ClassFileByDBTalbe(sqlSugarClient, ConnId, $@"C:\my-file\MineCosmos.Core.Api.Controllers", "MineCosmos.Core.Api.Controllers", tableNames, "", isMuti);
            return true;
        }
        ...
        {
            Create_Model_ClassFileByDBTalbe(sqlSugarClient, ConnId, $@"C:\my-file\MineCosmos.Core.Model", "MineCosmos.Core.Model.Models", tableNames, "", isMuti);
            return true;
        }
        ...
        {
            Create_IRepository_ClassFileByDBTalbe(sqlSugarClient, ConnId, $@"C:\my-file\MineCosmos.Core.IRepository", "MineCosmos.Core.IRepository", tableNames, "", isMuti);
            return true;
        }
        ...
        {
            Create_IServices_ClassFileByDBTalbe(sqlSugarClient, ConnId, $@"C:\my-file\MineCosmos.Core.IServices", "MineCosmos.Core.IServices", tableNames, "", isMuti);
            return true;
        }
        ...
        {
            Create_Repository_ClassFileByDBTalbe(sqlSugarClient, ConnId, $@"C:\my-file\MineCosmos.Core.Repository", "MineCosmos.Core.Repository", tableNames, "", isMuti);
            return true;
        }
        ...
        {
            Create_Services_ClassFileByDBTalbe(sqlSugarClient, ConnId, $@"C:\my-file\MineCosmos.Core.Services", "MineCosmos.Core.Services", tableNames, "", isMuti);
            return true;
        }
...
using MineCosmos.Core.Model.Models" + (isMuti ? "." + ConnId + "" : "") + @";
    ...
    public interface I{ClassName}Services :IBaseServices<{ClassName}>" + (string.IsNullOrEmpty(strInterface) ? "" : (" , " + strInterface)) + @"
	{
          ...
          bool isMuti = false)
        {
            ...
            var ls = IDbFirst.IsCreateDefaultValue().IsCreateAttribute()
                  ...
                  .SettingClassTemplate(p => p =
@"using MineCosmos.Core.IRepository" + (isMuti ? "." + ConnId + "" : "") + @";
using MineCosmos.Core.IRepository.UnitOfWork;
using MineCosmos.Core.Model.Models" + (isMuti ? "." + ConnId + "" : "") + @";
using MineCosmos.Core.Repository.Base;
    ...
    public class {ClassName}Repository : BaseRepository<{ClassName}>, I{ClassName}Repository" + (string.IsNullOrEmpty(strInterface) ? "" : (" , " + strInterface)) + @"
    {
          ...
          bool isMuti = false)
        {
            ...
            var ls = IDbFirst.IsCreateDefaultValue().IsCreateAttribute()
                  ...
                  .SettingClassTemplate(p => p =
@"
using MineCosmos.Core.IServices" + (isMuti ? "." + ConnId + "" : "") + @";
using MineCosmos.Core.Model.Models" + (isMuti ? "." + ConnId + "" : "") + @";
